...
func init() {
	...
	// groupDescCodexWsOnly is the schema descriptor for codex_ws_only field.
	groupDescCodexWsOnly := groupFields[49].Descriptor()
	// group.DefaultCodexWsOnly holds the default value on creation for the codex_ws_only field.
	group.DefaultCodexWsOnly = groupDescCodexWsOnly.Default.(bool)
