...
func init() {
	...
	// groupDescCodexCliOnly is the schema descriptor for codex_cli_only field.
	groupDescCodexCliOnly := groupFields[50].Descriptor()
	// group.DefaultCodexCliOnly holds the default value on creation for the codex_cli_only field.
	group.DefaultCodexCliOnly = groupDescCodexCliOnly.Default.(bool)
	// groupDescCodexCliOnlyAllowAppServer is the schema descriptor for codex_cli_only_allow_app_server field.
	groupDescCodexCliOnlyAllowAppServer := groupFields[51].Descriptor()
	// group.DefaultCodexCliOnlyAllowAppServer holds the default value on creation for the codex_cli_only_allow_app_server field.
	group.DefaultCodexCliOnlyAllowAppServer = groupDescCodexCliOnlyAllowAppServer.Default.(bool)
