-- Compensate migration 239 without rewriting applied migration history.
-- Restore the group invalidation trigger before removing its referenced field.
...
ALTER TABLE groups DROP COLUMN IF EXISTS codex_ws_only;
